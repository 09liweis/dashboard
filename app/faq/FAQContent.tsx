    ...
    <div className="min-h-screen bg-white">
      <section className="border-b border-gray-100">
        <div className="max-w-3xl mx-auto px-6 pt-16 pb-14 md:pt-24 md:pb-20">
          <div>
            <p className="text-sm font-semibold uppercase tracking-widest text-emerald-600 mb-3">FAQ</p>
            <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight text-gray-900 mb-4">Frequently Asked Questions</h1>
      ...
      <section className="border-t border-gray-100 bg-gray-50 py-16 md:py-20">
        <div className="max-w-3xl mx-auto px-6 text-center">
          <div>
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-3">Still have questions?</h2>
            <p className="text-gray-500 mb-8 max-w-md mx-auto">Send me a message and I will get back to you within a few hours.</p>
            <a href="mailto:weisen.li@hotmail.com" className="inline-flex items-center gap-2 px-7 py-3 bg-slate-900 text-white rounded-lg font-semibold hover:bg-slate-800 transition-colors">
              <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
