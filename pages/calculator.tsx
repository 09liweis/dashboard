...
const CATEGORIES: Category[] = [
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        id: "4-7",
        label: "4–7 Pages",
        description: "Adds Services, Blog, FAQ",
        price: 400,
      },
      {
        id: "8-15",
        label: "8–15 Pages",
        description: "Larger informational site",
        price: 900,
      },
      {
        id: "15+",
        label: "15+ Pages",
        description: "Multi-section or large catalog",
        price: 1800,
      },
    ],
  },
  {
    ...
    options: [
      {
        id: "template",
        label: "Adapted Template",
        description: "Start from a proven layout and customize it",
        price: 0,
      },
      {
        id: "custom",
        label: "Custom Design",
        description: "Unique design built from scratch to your brand",
        price: 1200,
      },
      {
        id: "figma",
        label: "From Figma / Brand Guide",
        description: "Pixel-perfect implementation of provided designs",
        price: 800,
      },
    ],
  },
    ...
    options: [
      {
        id: "contact-form",
        label: "Contact Form",
        description: "Email submissions with spam protection",
        price: 150,
      },
      {
        id: "cms",
        label: "Content Management (CMS)",
        description: "Edit pages and blog posts without a developer",
        price: 600,
      },
      {
        id: "blog",
      ...
      },
      {
        ...
        description: "Stripe integration for one-time or recurring payments",
        price: 1200,
      },
      {
        id: "multilang",
        label: "Multi-Language Support",
        description: "Content in 2 or more languages",
        price: 700,
      },
      {
        id: "search",
        label: "Search Functionality",
        description: "Full-text search across site content",
        price: 400,
      },
      {
        id: "analytics",
        label: "Analytics Dashboard",
        description: "Custom internal metrics and reporting",
        price: 900,
      },
    ],
  },
  {
    ...
    options: [
      {
        id: "free-tier",
        label: "Free Tier (Vercel / Netlify)",
        description: "Ideal for static and low-traffic sites — $0/month",
        price: 0,
      },
      {
        id: "managed",
        label: "Managed Cloud Hosting",
        description: "Vercel Pro, Railway, Render — ~$20–50/month",
        price: 200,
      },
      {
        id: "vps",
        label: "VPS / Dedicated Server",
        description: "Full control on AWS, DigitalOcean, etc.",
        price: 400,
      },
    ],
  },
  {
    ...
    options: [
      {
        id: "flexible",
        label: "Flexible (6–10 weeks)",
        description: "Standard pace with thorough review cycles",
        price: 0,
      },
      {
        id: "normal",
        label: "Normal (3–5 weeks)",
        description: "Prioritized delivery with focused sprints",
        price: 300,
      },
      {
        id: "rush",
        label: "Rush (1–2 weeks)",
        description: "Expedited development, all hands on deck",
        price: 800,
      },
    ],
  },
...
const ADDONS: Option[] = [
  {
    ...
    label: "SEO Setup",
    description:
      "Meta tags, sitemap, structured data, Search Console integration",
    price: 400,
  },
  {
    id: "a11y",
  ...
  },
  {
    ...
    description: "Core Web Vitals tuning, Lighthouse 90+ guarantee",
    price: 500,
  },
  {
    id: "support",
    label: "3-Month Support Retainer",
    description: "Bug fixes, minor updates, and priority email support",
    price: 600,
  },
  {
    id: "migration",
    label: "WordPress Migration",
    description: "Content migration from an existing WordPress site",
    price: 700,
  },
];
          ...
          <div className="max-w-4xl mx-auto px-6 pt-14 pb-12 md:pt-20 md:pb-16">
            <div>
              ...
              <p className="text-lg text-gray-500 leading-relaxed max-w-2xl">
                ...
                itemized estimate. No email required.
              </p>
            </div>
              ...
              {CATEGORIES.map((cat) => (
                <section key={cat.id}>
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    {cat.options.map((opt) => {
                      const isSelected = (selections[cat.id] || []).includes(
                        opt.id
                      );
                      return (
                        <button
              ...
              <div className="rounded-2xl border border-gray-200 bg-white shadow-lg overflow-hidden">
                ...
                <div className="px-6 py-5">
                  ...
                  <p className="text-xs text-gray-400 text-center mt-4 leading-relaxed">
                    Estimates are approximate. Final pricing depends on exact
                    requirements and a brief discovery call.
                  </p>
                </div>
              </div>
