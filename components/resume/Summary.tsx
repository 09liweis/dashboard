  ...
  return (
    ...
    >
      ...
      <p className="text-gray-700 leading-relaxed">
        Passionate full-stack developer with <span className="font-semibold text-blue-600 underline">10+ years</span> of experience 
        building scalable web applications using modern technologies. Expertise in 
        <span className="font-semibold text-purple-600 underline decoration-purple-600 decoration-wavy"> JavaScript, React, Vue, Node.js, and cloud services</span>. 
