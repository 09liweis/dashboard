            ...
            <div className="flex items-start gap-4 mb-6">
              ...
              <div className="flex-1">
                <p className="text-base sm:text-lg text-slate-700 leading-relaxed mb-5">
                  I&apos;ve spent the last decade building web applications that
                  actually work. Not just the shiny frontend stuff, but the
                  whole stack—databases, APIs, deployment, the works. I focus on
                  writing code that other developers can understand six months
                  later.
                </p>
                ...
                <div className="space-y-3">
                  <div className="flex items-start gap-3 bg-white rounded-lg p-3 border border-slate-200">
                    ...
                    <p className="text-slate-600 text-sm leading-relaxed">
                      I&apos;ve led teams through technical migrations (jQuery
                      to React, monoliths to microservices) and actually shipped
                      them. I enjoy mentoring junior developers and doing code
                      reviews that help people grow.
                    </p>
                  </div>
                  ...
                  <div className="flex items-start gap-3 bg-white rounded-lg p-3 border border-slate-200">
                    ...
                    <p className="text-slate-600 text-sm leading-relaxed">
                      My approach is pragmatic: use the right tool for the job,
                      optimize when it matters, and keep things simple when
                      possible. I&apos;ve dealt with everything from small
                      startup MVPs to systems handling millions of records.
                    </p>
                  </div>
                  ...
                  <div className="flex items-start gap-3 bg-white rounded-lg p-3 border border-slate-200">
                    ...
                    <p className="text-slate-600 text-sm leading-relaxed">
                      Currently working with React, Vue, Node.js, and various
                      databases. I pick up new technologies quickly and I&apos;m
                      comfortable jumping into unfamiliar codebases.
                    </p>
                  </div>
                </div>
              </div>
