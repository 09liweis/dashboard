      ...
      >
        ...
        <div className="p-6 space-y-4">
          <div className="space-y-2">
            ...
            <div className="relative">
              <input
                id="emal"
                ref={emailInput}
                className="w-full caret-purple-600 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
          ...
          <button
            ...
            className="w-full py-3 px-4 bg-linear-to-r from-blue-600 to-purple-600 text-white rounded-lg font-medium hover:from-blue-700 hover:to-purple-700 focus:outline-hidden focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-colors disabled:opacity-50 flex items-center justify-center"
          >
          ...
          <a
            ...
            className="w-full py-3 px-4 flex items-center justify-center space-x-2 bg-gray-900 text-white rounded-lg hover:bg-gray-800 focus:outline-hidden focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition-colors"
          >
