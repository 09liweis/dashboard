  ...
  return (
    <div className="mb-6">
      <input 
        ...
        className="w-full p-3 rounded-lg bg-white border border-gray-200 shadow-xs focus:border-blue-500 focus:ring-2 focus:ring-blue-200 transition-all mb-4"
      />
      
      <div className="grid grid-cols-3 gap-4 text-center text-gray-500">
      {stats.map(({tl,value,color})=>
        <div key={tl} className="bg-white p-1 sm:p-4 rounded-lg shadow-xs border border-gray-100">
